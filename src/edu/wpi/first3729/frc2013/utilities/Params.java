...
import edu.wpi.first3729.frc2013.inputs.Input;
/**
 *
 * @author teddy
 */
public class Params {
    ...
    //Defaults
    public static final int default_drive_mode = Input.arcadecontroller;
...
//    public static final int target_luminence_high;
    ...
    //Used to initiate testing messages
